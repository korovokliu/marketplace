...
class McatCategoryTest(TestCase):
    ...
    def create_obj(self, slug="obj_slug", name="Obj name", status=0, template_name='default', parent=None):
        ...
        obj = Category.objects.create(slug=slug, name=name, image=self.image, status=status, parent=parent,
...
class McatProductCaracteristicTest(TestCase):
    ...
    def create_category_caracteristic(self, slug="slug", category=None, ftype='boolean', choices=choices,
                                      name='carac_name'):
        if category is None:
    ...
    def create_product(self, ftype='boolean', category=None, category_carac=True, name='product', slug='obj-slug',
                       carac1='', carac2='', carac3='', carac4='', carac5='', int_carac1=None, int_carac2=None,
                       int_carac3=None, int_carac1_name='', int_carac2_name='', int_carac3_name=''):
        if category is None:
            category = self.create_category()
    ...
    def create_obj(self, product, ftype, value, name, type_name='', value_name=''):
        obj = ProductCaracteristic.objects.create(name=name, product=product, value=value, type=ftype,
    ...
    def test_save_int_caracteristics(self):
        category = self.create_category()
        cat_carac1 = self.create_category_caracteristic(slug="cslug1", category=category, ftype='boolean', choices='',
                                                        name='carac_name1')
        cat_carac2 = self.create_category_caracteristic(slug="cslug2", category=category, ftype='boolean', choices='',
                                                        name='carac_name2')
        cat_carac3 = self.create_category_caracteristic(slug="cslug3", category=category, ftype='boolean', choices='',
                                                        name='carac_name3')
        cat_carac4 = self.create_category_caracteristic(slug="cslug4", category=category, ftype='boolean', choices='',
                                                        name='carac_name4')
        cat_carac5 = self.create_category_caracteristic(slug="cslug5", category=category, ftype='choices',
                                                        choices=choices, name='carac_name5')
        int_cat_carac1 = self.create_category_caracteristic(slug="cslug6", category=category, ftype='int', choices='',
                                                            name='carac_name6')
        int_cat_carac2 = self.create_category_caracteristic(slug="cslug7", category=category, ftype='int', choices='',
                                                            name='carac_name7')
        int_cat_carac3 = self.create_category_caracteristic(slug="cslug8", category=category, ftype='int', choices='',
                                                            name='carac_name8')
